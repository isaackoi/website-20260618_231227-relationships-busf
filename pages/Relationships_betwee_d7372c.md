...
- Relationships_betwee_d7372c_index
...
show_ads: true
description: UFOs and science fiction have never been the same thing, but they have shaped each other for more than a century.
hero_summary: UFOs and science fiction have never been the same thing, but they have shaped each other for more than a century. A UFO is simply an unidentified flying object or, in newer official language, an unidentified anomalous phenomenon; science fiction is a genre of imaginative storytelling.
layout: default
permalink: /relationships-betwee/
nav_short_title: Relationships betwee
title: Relationships betwee
title_full: Relationships betwee
display_title_short: Relationships betwee
display_title: Relationships betwee
source_count: 120
infographic_count: 3
page_website_name: UFO Fiction
page_banner_line: How sky mysteries, science fiction, secrecy, and public belief keep reshaping each other.
site_website_name: UFO Fiction
site_banner_line: How sky mysteries, science fiction, secrecy, and public belief keep reshaping each other.
site_image_description: A nighttime roadside scene shows people looking up at a glowing saucer-shaped object above distant mountains while film reels, pulp...
...
header:
  ...
  preview_image: /assets/images/Relationships_betwee_d7372c-overview.webp
...
<img src="{{ "/assets/images/Relationships_betwee_d7372c-Illustration-1-dark.svg" | relative_url }}" alt="Relationships betwee illustration 1" data-theme-src-dark="{{ "/assets/images/Relationships_betwee_d7372c-Illustration-1-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Relationships_betwee_d7372c-Illustration-1-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
<img src="{{ "/assets/images/Relationships_betwee_d7372c-Illustration-3-dark.svg" | relative_url }}" alt="Relationships betwee illustration 3" data-theme-src-dark="{{ "/assets/images/Relationships_betwee_d7372c-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Relationships_betwee_d7372c-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
